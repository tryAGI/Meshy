...
namespace Meshy
{
    public partial interface IRetextureClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Meshy.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Meshy.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Meshy.RetextureTask>>> ListRetextureTasksAsResponseAsync(
            int? pageNum = default,
            int? pageSize = default,
            global::Meshy.ListRetextureTasksSortBy? sortBy = default,
            global::Meshy.AutoSDKRequestOptions? requestOptions = default,
