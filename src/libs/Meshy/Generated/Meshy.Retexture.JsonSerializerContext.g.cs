...
namespace Meshy
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(bool?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(long?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Meshy.ListRetextureTasksSortBy?), TypeInfoPropertyName = "NullableListRetextureTasksSortBy2")]
    ...
    internal sealed partial class RetextureSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class RetextureSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static RetextureSourceGenerationContext Default { get; } = new(DefaultOptions);

        private RetextureSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            public override bool CanConvert(global::System.Type typeToConvert)
            {
                return
                    ...
                    || typeToConvert == typeof(global::Meshy.ListRetextureTasksSortBy)
                ...
                global::System.Text.Json.JsonSerializerOptions options)
            {
                ...
                if (typeToConvert == typeof(global::Meshy.ListRetextureTasksSortBy))
                {
                    return new global::Meshy.JsonConverters.ListRetextureTasksSortByJsonConverter();
                }

                if (typeToConvert == typeof(global::Meshy.ListRetextureTasksSortBy?))
                {
                    return new global::Meshy.JsonConverters.ListRetextureTasksSortByNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new RetextureSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
