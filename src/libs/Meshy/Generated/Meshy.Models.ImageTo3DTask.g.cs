...
namespace Meshy
{
    ...
    public sealed partial class ImageTo3DTask
    {
        ...
        public global::Meshy.ModelUrlsImageTo3D? ModelUrls { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Meshy.JsonConverters.TaskStatusJsonConverter))]
        public global::Meshy.TaskStatus? Status { get; set; }

        /// <summary>
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("texture_urls")]
        public global::System.Collections.Generic.IList<global::Meshy.TextureUrlSet>? TextureUrls { get; set; }
        ...
        public global::Meshy.TaskError? TaskError { get; set; }
        ...
        public ImageTo3DTask(
            string? id,
            string? type,
            global::Meshy.ModelUrlsImageTo3D? modelUrls,
            string? thumbnailUrl,
            string? texturePrompt,
            string? textureImageUrl,
            int? progress,
            global::Meshy.TaskStatus? status,
            global::System.Collections.Generic.IList<global::Meshy.TextureUrlSet>? textureUrls,
            int? precedingTasks,
            global::Meshy.TaskError? taskError,
            long? createdAt,
            long? startedAt,
            long? finishedAt,
            long? expiresAt)
